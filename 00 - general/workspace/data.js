...
const SEMESTERS = [
  "Nivelación", "1er semestre", "2do semestre", "3er semestre", "4to semestre",
  "5to semestre", "6to semestre", "7mo semestre", "8vo semestre", "9no semestre",
  "10mo semestre"
];

const AREAS = {
  MAT: { label: "Matemática",            color: "#8CADD1" },
  FIS: { label: "Física y Química",      color: "#7FA8C9" },
  EST: { label: "Estructuras",           color: "#9AC086" },
  MAE: { label: "Materiales y Procesos", color: "#C9B87F" },
  FLU: { label: "Fluidos y Aerodinámica",color: "#E38358" },
  PRO: { label: "Propulsión",            color: "#D96F55" },
  SIS: { label: "Sistemas y Control",    color: "#B08ACD" },
  GES: { label: "Gestión y Profesión",   color: "#DCB259" }
};
...
const SUBJECTS = [
  { code:"D1001", name:"Matemática para Ingeniería", type:"CB", sem:0, het:125, prereqs:[], area:"MAT",
    dir:"00 - nivelacion/D1001 - matematica para ingenieria",
    concepts:["álgebra","trigonometría","funciones","geometría analítica"] },

  { code:"F1301", name:"Matemática A", type:"CB", sem:1, het:192, prereqs:["D1001"], area:"MAT",
    dir:"1er semestre/F1301 - matemarica a",
    concepts:["límite","derivada","integral","funciones de una variable"] },
  { code:"M1602", name:"Gráfica para Ingeniería", type:"CB", sem:1, het:96, prereqs:[], area:"MAE",
    dir:"1er semestre/M1602 - grafica para ingenieria",
    concepts:["proyecciones","CAD","normalización","tolerancias"] },
  { code:"A1101", name:"Introducción a la Ingeniería Aeroespacial", type:"CO", sem:1, het:48, prereqs:[], area:"GES",
    dir:"1er semestre/A1101 - introduccion a la ing aeroespacial",
    concepts:["historia aeronáutica","atmósfera","partes de la aeronave","misión"] },

  { code:"F1302", name:"Matemática B", type:"CB", sem:2, het:192, prereqs:["F1301"], area:"MAT",
    dir:"2do semestre/F1302 - matematica b",
    concepts:["álgebra lineal","matrices","integral múltiple","series"] },
  { code:"F1303", name:"Física I", type:"CB", sem:2, het:128, prereqs:["F1301"], area:"FIS",
    dir:"2do semestre/F1303 - fisica I",
    concepts:["cinemática","dinámica newtoniana","trabajo y energía","estática"] },
  { code:"U1901", name:"Química para Ingeniería", type:"CB", sem:2, het:96, prereqs:[], area:"FIS",
    dir:"2do semestre/U1901 - quimica para ingenieria",
    concepts:["enlace químico","estequiometría","termoquímica","corrosión"] },

  { code:"F1304", name:"Matemática C", type:"CB", sem:3, het:144, prereqs:["F1302"], area:"MAT",
    dir:"3er semeste/F1304 - matematica c",
    concepts:["ecuaciones diferenciales","cálculo vectorial","campos"] },
  { code:"F1305", name:"Física II", type:"CB", sem:3, het:128, prereqs:["F1302","F1303"], area:"FIS",
    dir:"3er semeste/F1305 - fisica II",
    concepts:["electromagnetismo","ondas","circuitos","óptica"] },
  { code:"F1315", name:"Probabilidades y Estadística", type:"CB", sem:3, het:96, prereqs:["F1302"], area:"MAT",
    dir:"3er semeste/F1315 - probabilidades estatadistica",
    concepts:["probabilidad","distribuciones","inferencia","regresión"] },

  { code:"F1306", name:"Matemática D", type:"CB", sem:4, het:96, prereqs:["F1304"], area:"MAT",
    dir:"4to semestre/F1306 - matematica d",
    concepts:["variable compleja","transformada de Fourier","Laplace","EDP"] },
  { code:"F1316", name:"Introducción a la Programación y Análisis Numérico", type:"CB", sem:4, het:80, prereqs:["F1304"], area:"SIS",
    dir:"4to semestre/F1316 - intro prog analisis numerico",
    concepts:["programación","métodos numéricos","interpolación","error numérico"] },
  { code:"C1151", name:"Estructuras I", type:"TB", sem:4, het:96, prereqs:["F1303"], area:"EST",
    dir:"4to semestre/C1151 - estructuras I",
    concepts:["estática","reticulados","diagramas de esfuerzos","equilibrio"] },
  { code:"M1603", name:"Materiales", type:"TB", sem:4, het:80, prereqs:["U1901"], area:"MAE",
    dir:"4to semestre/M1603 - materiales",
    concepts:["estructura cristalina","diagramas de fase","tratamientos térmicos","ensayos mecánicos"] },

  { code:"A1102", name:"Materiales Aeroespaciales", type:"TB", sem:5, het:40, prereqs:["M1603"], area:"MAE",
    dir:"5to semestre/A1102 - materiales aeroespaciales",
    concepts:["aleaciones de aluminio","composites","fatiga","titanio"] },
  { code:"A1006", name:"Ensayos no Destructivos", type:"TB", sem:5, het:40, prereqs:["M1603","F1305"], area:"MAE",
    dir:"5to semestre/A1006 - ensayos no destructivos",
    concepts:["ultrasonido","radiografía","líquidos penetrantes","detección de fisuras"] },
  { code:"M1604", name:"Termodinámica", type:"TB", sem:5, het:96, prereqs:["F1302","F1303","U1901"], area:"PRO",
    dir:"5to semestre/M160 - termodinamica",
    concepts:["primer principio","segundo principio","ciclos térmicos","gases ideales"] },
  { code:"C1153", name:"Estructuras II", type:"TB", sem:5, het:96, prereqs:["C1151","F1302","M1603"], area:"EST",
    dir:"5to semestre/C1153 - estructuras II",
    concepts:["tensión y deformación","flexión","torsión","pandeo"] },
  { code:"A1009", name:"Mecánica Racional", type:"TB", sem:5, het:96, prereqs:["F1303","F1304"], area:"FIS",
    dir:"5to semestre/A1009 - mecanica racional",
    concepts:["dinámica del rígido","Lagrange","vibraciones","cinemática espacial"] },

  { code:"A1010", name:"Electrotecnia y Sistemas Eléctricos de Aeronaves", type:"TB", sem:6, het:96, prereqs:["F1304","F1305"], area:"SIS",
    dir:"6to semestre/A1010 electrotecnia sistemas electronicos",
    concepts:["circuitos","máquinas eléctricas","electrónica","sistemas de a bordo"] },
  { code:"A1011", name:"Mecánica de los Fluidos I", type:"TB", sem:6, het:96, prereqs:["F1306","F1316","M1604"], area:"FLU",
    dir:"6to semestre/A1011 - mecanica fluidos I",
    concepts:["ecuación de Bernoulli","Navier-Stokes","capa límite","flujo potencial"] },
  { code:"A1016", name:"Mecanismos y Sistemas de Aeronaves", type:"TA", sem:6, het:96, prereqs:["A1009","C1153","M1603"], area:"SIS",
    dir:"6to semestre/A1016 - mecanismos sistemas",
    concepts:["mecanismos","transmisiones","sistemas hidráulicos","tren de aterrizaje"] },
  { code:"A1008", name:"Estructuras III", type:"TA", sem:6, het:96, prereqs:["C1153","F1316"], area:"EST",
    dir:"6to semestre/A1008 . estructuras III",
    concepts:["elementos finitos","matriz de rigidez","estructuras hiperestáticas","energía de deformación"] },
  { code:"DA200", name:"Actividad Formación Comp. I", type:"CO", sem:6, het:0, prereqs:[], area:"GES",
    dir:"6to semestre/DA200 - actividad formacion comp I", concepts:[] },

  { code:"A1013", name:"Estructuras IV", type:"TA", sem:7, het:80, prereqs:["A1102","A1008"], area:"EST",
    dir:"7mo semestre/A1013 - estructuras IV",
    concepts:["estructuras aeronáuticas","semimonocasco","larguerillos","cargas de vuelo"] },
  { code:"A1015", name:"Mecánica de los Fluidos II", type:"TB", sem:7, het:96, prereqs:["A1011","F1315"], area:"FLU",
    dir:"7mo semestre/A1015 - mecanica fluidos II",
    concepts:["flujo compresible","ondas de choque","turbulencia","toberas"] },
  { code:"A1012", name:"Sistemas Dinámicos", type:"TA", sem:7, het:80, prereqs:["F1305","F1315","A1009","A1008"], area:"SIS",
    dir:"7mo semestre/A1012 - sistemas dinamicos",
    concepts:["espacio de estados","respuesta en frecuencia","estabilidad","vibraciones"] },
  { code:"P1752", name:"Economía para Ingenieros y Org. Industrial", type:"CO", sem:7, het:48, prereqs:[], area:"GES",
    dir:"7mo semestre/P1752 - economia ingenieros",
    concepts:["costos","evaluación de proyectos","organización industrial"] },
  { code:"S0001", name:"Electiva Humanística", type:"CO", sem:7, het:48, prereqs:[], area:"GES",
    dir:"7mo semestre/S0001 - electiva humanistica", concepts:[] },
  { code:"DA300", name:"Actividad Formación Comp. II", type:"CO", sem:7, het:0, prereqs:["DA200"], area:"GES",
    dir:"7mo semestre/DA300 - actividad  formacion comp II", concepts:[] },

  { code:"A1017", name:"Motores a Reacción", type:"TA", sem:8, het:80, prereqs:["A1015"], area:"PRO",
    dir:"8vo semestre/A1017 - motores reaccion",
    concepts:["ciclo Brayton","turbina","compresor","empuje"] },
  { code:"A1018", name:"Aerodinámica y Mecánica de Vuelo I", type:"TA", sem:8, het:96, prereqs:["A1015","A1009"], area:"FLU",
    dir:"8vo semestre/A1018 - aerodinamica mecanica vuelo I",
    concepts:["perfil alar","sustentación","resistencia","performance de vuelo"] },
  { code:"A1019", name:"Procesos de Fabricación", type:"TA", sem:8, het:80, prereqs:["A1102"], area:"MAE",
    dir:"8vo semestre/A1019 - procesos fabricacion",
    concepts:["mecanizado","conformado","uniones","fabricación de composites"] },
  { code:"A1014", name:"Estructuras V", type:"TA", sem:8, het:80, prereqs:["A1013"], area:"EST",
    dir:"8vo semestre/A1014 - estructuras V",
    concepts:["aeroelasticidad","fatiga estructural","tolerancia al daño","damage tolerance"] },
  { code:"P1759", name:"Ingeniería Legal y Ejercicio Profesional", type:"CO", sem:8, het:48, prereqs:[], area:"GES",
    dir:"8vo semestre/P1759 - ingenieria legal ejercicio profecional",
    concepts:["normativa","certificación","responsabilidad profesional"] },
  { code:"DA400", name:"Actividad Formación Comp. III", type:"CO", sem:8, het:0, prereqs:["DA300"], area:"GES",
    dir:"8vo semestre/DA400 - actividad formacioncomp III", concepts:[] },

  { code:"A1020", name:"Motores Alternativos", type:"TA", sem:9, het:80, prereqs:["A1012","A1016","M1604"], area:"PRO",
    dir:"9no semestre/A1020 - motores alternativos",
    concepts:["ciclo Otto","hélices","refrigeración","combustión"] },
  { code:"A1022", name:"Aerodinámica y Mecánica de Vuelo II", type:"TA", sem:9, het:96, prereqs:["A1018","A1012"], area:"FLU",
    dir:"9no semestre/A1022 - aerodinamica mecanica vuelo II",
    concepts:["estabilidad y control","derivadas aerodinámicas","cualidades de vuelo","modos dinámicos"] },
  { code:"A1021", name:"Mediciones e Instrumentos de Aeronaves", type:"TA", sem:9, het:96, prereqs:["A1010","A1016"], area:"SIS",
    dir:"9no semestre/A1021 - mediciones instrumentos",
    concepts:["sensores","incertidumbre de medición","aviónica","adquisición de datos"] },
  { code:"A1028", name:"Aeropuertos y Operaciones de Vuelo", type:"TA", sem:9, het:96, prereqs:["A1018","A1017"], area:"GES",
    dir:"9no semestre/A1028 - aeropuertos operaciones vuelo",
    concepts:["operaciones","planificación de vuelo","infraestructura aeroportuaria","tránsito aéreo"] },
  { code:"DA500", name:"Actividad Formación Comp. IV", type:"CO", sem:9, het:0, prereqs:["DA400"], area:"GES",
    dir:"9no semestre/DA500 - actividades formacion comp IV", concepts:[] },

  { code:"A1023", name:"Control y Guiado", type:"TA", sem:10, het:80, prereqs:["A1012","A1021"], area:"SIS",
    dir:"10mo semestre/A1023 - control guiado",
    concepts:["control automático","piloto automático","navegación","guiado"] },
  { code:"A1024", name:"Talleres y Mantenimiento Aeronáutico", type:"TA", sem:10, het:96, prereqs:["A1022"], area:"MAE",
    dir:"10mo semestre/A2024 - talleres matenimiento",
    concepts:["mantenimiento","aeronavegabilidad","inspección","reparaciones"] },
  { code:"A1026", name:"Sistemas y Equipos de Aeronaves", type:"TA", sem:10, het:64, prereqs:["A1022"], area:"SIS",
    dir:"10mo semestre/A1026 - sistemas equipos",
    concepts:["presurización","sistemas de combustible","ambiental","equipos de a bordo"] },
  { code:"A1025", name:"Optativa", type:"TA", sem:10, het:128, prereqs:[], area:"GES",
    dir:"10mo semestre/A1025 - optativa", concepts:[] },
  { code:"DA600", name:"Actividad Formación Comp. V", type:"CO", sem:10, het:0, prereqs:["DA500"], area:"GES",
    dir:"10mo semestre/DA600 -actividad formacion comp V", concepts:[] },
  { code:"A1034", name:"Práctica Profesional Supervisada (PPS)", type:"TA", sem:10, het:200, prereqs:[], area:"GES",
    dir:"10mo semestre/A1034 - pps practica profesional supervisada", concepts:[] }
];
...
/* Carpetas de nivel raíz que no son semestres */
const EXTRA_ROOTS = [
  { path:"00 - general",  label:"00 - general"  },
